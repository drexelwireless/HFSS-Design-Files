In this paper we propose a pattern reconfigurable planar antenna with integrated control circuitry, for flexible applications with Software Defined Radio (SDR) platforms. 
